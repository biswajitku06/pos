                ...
                <div class="box-content">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        @foreach($items as $item)
                            <tr>
                                <td>{{$item->id}}</td>
                                <td class="center">{{$item->sub_cat_name}}</td>
                                ...
                                <td class="center">
                                    ...
                                    @endif
                                    <a class="btn btn-info" href="{{route('editsubCategory', $item->id)}}">
                                        <i class="halflings-icon white edit"></i>
                                    </a>
                                    <a class="btn btn-danger" href="{{route('deletesubCategory', $item->id)}}" id="delete">
